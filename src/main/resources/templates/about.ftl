    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse pull-right">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="about.html" target="_self">关于我们</a></li>
    ...
    <div class="container">
        ...
        <div class="row ">
            <div class="col-md-12 column">
                ...
                <div class="jumbotron" style="background-image: url(./img/logo.png)">
...
<div class="thumbnail" style="margin: 50px">
    <div style="background-image: url(./img/body-bg.png)">
...
<div class="thumbnail" style="margin: 50px">
    <div id="shehui" style="background-image: url(./img/body-bg.png)">
        <div class="container" style="color: black">
            <div class="row">
...
<!--合作伙伴-->
<div class="thumbnail" style="margin: 50px">
    <div id="hezuo" style="background-image: url(./img/body-bg.png)">
...
<!--加入我们-->
<div class="thumbnail" style="margin: 50px">
    <div id="about-us" style="background-image: url(./img/body-bg.png)">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <div class="row clearfix pull-right">
                                <div class="col-md-12 column">
                        <li class=""><a id="modal-169753" href="#modal-container-169753" role="button" class="btn"
